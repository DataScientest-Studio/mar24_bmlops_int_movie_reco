...
def read_ratings(ratings_csv, data_dir="./src/data/data/raw") -> pd.DataFrame:
    """
...
def read_movies(movies_csv, data_dir="./src/data/data/raw") -> pd.DataFrame:
    """
...
if __name__ == "__main__":
    ...
    movies.to_csv("./src/data/data/processed/movie_matrix.csv", index=False)
    user_matrix.to_csv("./src/data/data/processed/user_matrix.csv")
